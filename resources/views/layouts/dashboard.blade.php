            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="#">مجموعات العناصر</a>
                  </li>
                  <li class="nav-item">
                        ...
                        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                            ...
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                <li class="nav-item">
                                    ...
                                    <i class="fs-4 bi bi-box-seam"></i> <span class="ms-1 d-none d-sm-inline text-white">المنتجات</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('additem')}}" class="nav-link align-middle px-0">
                                    <i class="fs-4 bi bi-collection"></i> <span class="ms-1 d-none d-sm-inline text-white">إضافة مجموعة</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('Additems')}}" class="nav-link px-0 align-middle">
                                        <i class="fs-4 bi-table"></i> <span class="ms-1 d-none d-sm-inline text-white">اضافة عنصر</span></a>
                                </li>
                                <li>
                                    <a href="{{route('bills')}}" class="nav-link px-0 align-middle ">
                                    <i class="fs-4 bi bi-receipt-cutoff"></i> <span class="ms-1 d-none d-sm-inline text-white">الفواتير</span></a>
